                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    <div class="action-btn edit">
                                        <i class="fas fa-edit" data-toggle="modal" data-target="#editModal-{{ $class->id }}"></i>
                                    </div>
                                    <div class="action-btn cancel">

                                        {{-- add onclick delte function --}}
                                        <a href="{{ route('consultant.deleteGroupClass', $class->id) }}"
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('consultant.createGroupClass') }}" method="POST">
                                        @csrf
                    ...
                    <div class="modal fade" id="editModal-{{ $class->id }}" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('consultant.updateGroupClass') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="subject">
                                                        @foreach ($courses as $course)
                                                        <option value="{{ $course->course_name }}"
                                                                @if ($class->subject == $course->course_name) selected @endif>
                                                            {{ $course->course_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" name="start_date" class="form-control"
                                                        value="{{ date('Y-m-d\TH:i', strtotime($class->start_date)) }}" required>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" name="end_date" class="form-control"
                                                        value="{{ date('Y-m-d\TH:i', strtotime($class->end_date)) }}" required>
                                                </div>
                                            </div>
                                        </div>
